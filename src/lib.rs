...
impl TemplateProgram {
    ...
    /// Like [`flatten`](Self::flatten), but enables the given unstable features.
    ///
    /// ## Errors
    ///
    /// The string is not a valid SimplicityHL program, or it uses an unstable
    /// feature that is not enabled in `unstable_features`.
    ...
    /// Like [`new_with_dep`](Self::new_with_dep), but enables the given unstable
    /// features.
    ///
    /// ## Errors
    ///
    ...
    pub fn with_unstable_and_dep(
        ...
        let driver_program = Self::dependency_helper(
            source.clone(),
            dependency_map,
            unstable_features,
            &mut error_handler,
    ...
    /// Like [`new`](Self::new), but enables the given unstable features.
    ///
    /// ## Errors
    ///
    /// The string is not a valid SimplicityHL program, or it uses an unstable
    ...
    pub fn with_unstable<Str: Into<Arc<str>>>(
        ...
        let mut error_handler = ErrorCollector::new();
        let Some(parsed_program) = parse::Program::parse_from_str_with_errors(
            source.clone(),
            unstable_features,
            &mut error_handler,
        ) else {
...
mod functional_tests {
    ...
    fn compile_with_deps(path: &Path, dependency_map: &DependencyMap) -> CompiledProgram {
        ...
        CompiledProgram::with_unstable_and_dep(
            source,
            dependency_map,
